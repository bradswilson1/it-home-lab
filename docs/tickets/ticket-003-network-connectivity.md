...
4. Went into Control Panel > Network and Internet > Network Connections, noticed my Ethernet status was disabled. ![Status of ethernet is disabled](../images/ticket-003-enable.png)
